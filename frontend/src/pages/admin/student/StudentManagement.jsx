              ...
              <div className="flex flex-col sm:flex-row gap-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-8 flex-grow">
                  ...
                  <div>
                    ...
                    <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest inline-block mt-1 ${selectedStudent.status === 'Active' ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600'
