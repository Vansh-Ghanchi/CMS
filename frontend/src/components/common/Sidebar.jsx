...
export default function Sidebar() {
  ...
  return (
    <aside className="w-[300px] bg-[#F1F5F9] border-r border-[#E2E8F0] flex flex-col sticky top-0 h-screen shrink-0">
      <div className="p-8">
         <div className="flex items-center gap-4 mb-12">
            <div className="w-12 h-12 bg-primary rounded-[12px] flex items-center justify-center text-white shadow-lg shrink-0">
               <GraduationCap className="w-7 h-7" />
            </div>
            <div className="whitespace-nowrap">
               <h1 className="text-sm font-black text-[#1E293B] tracking-tight leading-tight uppercase">Campus Admin</h1>
               <p className="text-[10px] font-bold text-secondary uppercase tracking-widest mt-1 opacity-60">CENTRAL MANAGEMENT</p>
            </div>
         </div>
